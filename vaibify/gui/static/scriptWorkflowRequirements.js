...
var VaibifyWorkflowRequirements = (function () {
    ...
    function _flistAttestationRows(dictDetail, dictContext) {
        // The AI Declaration is a publication-time attestation (the
        // researcher's sign-off), so it lives here alongside the
        // rebuild attestation — a separate row, not folded together.
        return [
