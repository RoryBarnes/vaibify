...
a complete Level 3 project, and exports it as the tar shape
...
else's project and a snapshot that fails a Level 3 check is not
something a rerun can honestly compare against. **A report reads
...
architecture and announces its absence rather than defaulting it.
